...
public class TemaDaoJdbc extends GenericDaoJdbc<Tema, Integer> implements
	...
	public static String sqlToCreateTable() {
		return String.format(SQL_CREATE_TABLE, Tema.TABLE, Tema.ID,
				Tema.CATEGORIA, Tema.PREGUNTA, Tema.ID);
	}
	...
	public void create(Tema tema) {
		this.updateSql(String.format(SQL_INSERT, Tema.TABLE, Tema.ID,
				Tema.CATEGORIA, Tema.PREGUNTA, tema.getId(),
				tema.getCategoria(), tema.getPregunta()));
	}
	...
	public void update(Tema tema) {
		this.updateSql(String.format(SQL_UPDATE, Tema.TABLE, Tema.CATEGORIA,
				tema.getCategoria(), Tema.PREGUNTA, tema.getPregunta(),
				tema.getId()));
