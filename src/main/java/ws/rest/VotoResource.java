...
public class VotoResource {
	...
	public Voto consultar(@PathParam("id") Integer id) {
		...
		if (voto == null) {
			...
			LogManager.getLogger(clazz).debug(
					"GET: " + VotoUris.PATH_VOTOS + "/" + id + ": " + voto);
			return voto;
		}
	}
	...
	public ListNivelEstudios getStudiesLevel() {
		...
		LogManager.getLogger(clazz).debug(
				"GET: " + VotoUris.PATH_VOTOS + "/"
						+ VotoUris.PATH_NIVELESTUDIOS + ": "
						+ nivelEstudiosList);
